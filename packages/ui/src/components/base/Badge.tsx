...
export type BadgeVariant = "default" | "success" | "warning" | "danger" | "info" | "orange" | "gray";
...
export function Badge({ variant = "default", size = "md", dot = false, className = "", children, ...props }: BadgeProps) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 font-semibold rounded-full ${VARIANTS[variant]} ${sizeClass} ${className}`}
      {...props}
    >
